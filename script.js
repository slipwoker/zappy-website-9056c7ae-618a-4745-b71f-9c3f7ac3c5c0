    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Ariel Megidish Tv IL משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '9056c7ae-618a-4745-b71f-9c3f7ac3c5c0',
                    name: data.name || '',
                    email: data.email || '',
